		...
		xhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				if(txt != "[]"){
					...
					chrome.storage.sync.set({u_finish_time: project[0].u_finish_time, sessionID: 0, userID: project[0].user_id, projectID : project[0].project, pre_session_form : project[0].pre_session_form, pos_session_form : project[0].pos_session_form, pre_study_form : project[0].pre_study_form, pos_study_form : project[0].pos_study_form, next_episode_form : project[0].next_episode_form, p_start_time : project[0].p_start_time, p_finish_time : project[0].p_finish_time, has_devices : project[0].has_devices, has_forms : project[0].forms, netflix : project[0].netflix, youtube : project[0].youtube, amazonprime : project[0].amazonprime, hbo : project[0].hbo, disneyplus : project[0].disneyplus, pre_session_form_netflix : project[0].pre_session_form_netflix, next_episode_form_netflix : project[0].next_episode_form_netflix, pos_session_form_netflix : project[0].pos_session_form_netflix, pre_session_form_youtube : project[0].pre_session_form_youtube, next_episode_form_youtube : project[0].next_episode_form_youtube, pos_session_form_youtube : project[0].pos_session_form_youtube, pre_session_form_amazonprime : project[0].pre_session_form_amazonprime, next_episode_form_amazonprime : project[0].next_episode_form_amazonprime, pos_session_form_amazonprime : project[0].pos_session_form_amazonprime, pre_session_form_disneyplus : project[0].pre_session_form_disneyplus, next_episode_form_disneyplus : project[0].next_episode_form_disneyplus, pos_session_form_disneyplus : project[0].pos_session_form_disneyplus, pre_session_form_hbomax : project[0].pre_session_form_hbomax, next_episode_form_hbomax : project[0].next_episode_form_hbomax, pos_session_form_hbomax : project[0].pos_session_form_hbomax}, function(){
